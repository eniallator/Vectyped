# Contributing to Vects

Thank you for your interest in contributing to Vects! This document provides guidelines and instructions for contributing to the project.
...
2. **Clone your fork** locally:
   ...
   ```bash
   git clone https://github.com/YOUR-USERNAME/Vects.git
   cd Vects
   ```
...
Thank you for helping make Vects better! 🎉
